...
drISCOd\[Chi][\[Omega]_,\[Chi]1_,\[Nu]_,m_,\[Chi]0_,\[Nu]0_,m0_]:=1/2 ((6 \[Chi]1+1/(3 (1-\[Chi]1^2)^(2/3)) 2 ((1-\[Chi]1^2) (-(1/(1-\[Chi]1)^(2/3))+1/(1+\[Chi]1)^(2/3))-2 \[Chi]1 ((1-\[Chi]1)^(1/3)+(1+\[Chi]1)^(1/3))) (1+(1-\[Chi]1^2)^(1/3) ((1-\[Chi]1)^(1/3)+(1+\[Chi]1)^(1/3))))/(Sqrt[3 \[Chi]1^2+(1+(1-\[Chi]1^2)^(1/3) ((1-\[Chi]1)^(1/3)+(1+\[Chi]1)^(1/3)))^2])-(Sign[\[Chi]1] ((2-(1-\[Chi]1^2)^(1/3) ((1-\[Chi]1)^(1/3)+(1+\[Chi]1)^(1/3))) (-((2 \[Chi]1 ((1-\[Chi]1)^(1/3)+(1+\[Chi]1)^(1/3)))/(3 (1-\[Chi]1^2)^(2/3)))+((1-\[Chi]1)^(2/3)-(1+\[Chi]1)^(2/3))/(3 (1-\[Chi]1^2)^(1/3))+(6 \[Chi]1+1/(3 (1-\[Chi]1^2)^(2/3)) 2 ((1-\[Chi]1^2) (-(1/(1-\[Chi]1)^(2/3))+1/(1+\[Chi]1)^(2/3))-2 \[Chi]1 ((1-\[Chi]1)^(1/3)+(1+\[Chi]1)^(1/3))) (1+(1-\[Chi]1^2)^(1/3) ((1-\[Chi]1)^(1/3)+(1+\[Chi]1)^(1/3))))/(Sqrt[3 \[Chi]1^2+(1+(1-\[Chi]1^2)^(1/3) ((1-\[Chi]1)^(1/3)+(1+\[Chi]1)^(1/3)))^2]))+1/(3 (1-\[Chi]1^2)^(2/3)) (-((1-\[Chi]1^2) (-(1/(1-\[Chi]1)^(2/3))+1/(1+\[Chi]1)^(2/3)))+2 \[Chi]1 ((1-\[Chi]1)^(1/3)+(1+\[Chi]1)^(1/3))) (4+(1-\[Chi]1^2)^(1/3) ((1-\[Chi]1)^(1/3)+(1+\[Chi]1)^(1/3))+2 Sqrt[3 \[Chi]1^2+(1+(1-\[Chi]1^2)^(1/3) ((1-\[Chi]1)^(1/3)+(1+\[Chi]1)^(1/3)))^2])))/(\[Sqrt]((2-(1-\[Chi]1^2)^(1/3) ((1-\[Chi]1)^(1/3)+(1+\[Chi]1)^(1/3))) (4+(1-\[Chi]1^2)^(1/3) ((1-\[Chi]1)^(1/3)+(1+\[Chi]1)^(1/3))+2 Sqrt[3 \[Chi]1^2+(1+(1-\[Chi]1^2)^(1/3) ((1-\[Chi]1)^(1/3)+(1+\[Chi]1)^(1/3)))^2]))));
...
F\[Nu][\[Omega]_,\[Chi]_,\[Nu]_,m_,\[Chi]0_,\[Nu]0_,m0_]:=((-1 + Sqrt[1 - 4*\[Nu]])*Sqrt[1 - 4*\[Nu]]*(((1 + Sqrt[1 - 4*\[Nu]])^3*\[Nu]^3*\[Omega]^5*(30*\[Chi]*\[Omega]^(2/3) + 90*\[Chi]^3*\[Omega]^(2/3) - 36*\[Chi]^2*\[Omega] - 108*\[Chi]^4*\[Omega]))/60 - 
...
Fm[\[Omega]_,\[Chi]_,\[Nu]_,m_,\[Chi]0_,\[Nu]0_,m0_]:=((1 + Sqrt[1 - 4*\[Nu]])^3*\[Nu]^3*\[Omega]^5*(30*\[Chi]*\[Omega]^(2/3) + 90*\[Chi]^3*\[Omega]^(2/3) - 36*\[Chi]^2*\[Omega] - 108*\[Chi]^4*\[Omega]))/60 - 
 (2*\[Nu]^2*\[Omega]^5*(-3*\[Chi]*(16 + 33*\[Chi]^2)*\[Omega]^(2/3) - 4*(-6 - 70*\[Chi]^2 + 3*\[Chi]^4)*\[Omega] + 12*(-\[Chi] - 3*\[Chi]^3 + 2*Sqrt[-((-1 + \[Chi]^2)*\[Omega]^2)] + 26*\[Chi]^2*Sqrt[-((-1 + \[Chi]^2)*\[Omega]^2)] + 
      12*\[Chi]^4*Sqrt[-((-1 + \[Chi]^2)*\[Omega]^2)]) + 96*\[Chi]*(1 + 3*\[Chi]^2)*\[Omega]*Im[PolyGamma[0, 3 + ((2*I)*\[Chi])/Sqrt[1 - \[Chi]^2]]]))/15 + 
 ((1 + Sqrt[1 - 4*\[Nu]])^3*\[Nu]^2*\[Omega]^5*(-12*\[Chi] - 36*\[Chi]^3 - 33*\[Chi]*\[Omega]^(2/3) - 15*Sqrt[1 - 4*\[Nu]]*\[Chi]*\[Omega]^(2/3) - 54*\[Chi]^3*\[Omega]^(2/3) - 45*Sqrt[1 - 4*\[Nu]]*\[Chi]^3*\[Omega]^(2/3) + 12*\[Omega] + 
    140*\[Chi]^2*\[Omega] - 6*\[Chi]^4*\[Omega] + 12*Sqrt[(1 - 4*\[Nu])*\[Omega]^2] + 140*\[Chi]^2*Sqrt[(1 - 4*\[Nu])*\[Omega]^2] - 6*\[Chi]^4*Sqrt[(1 - 4*\[Nu])*\[Omega]^2] + 156*\[Chi]^2*Sqrt[(1 - \[Chi]^2)*\[Omega]^2] + 
    72*\[Chi]^4*Sqrt[(1 - \[Chi]^2)*\[Omega]^2] + 12*Sqrt[-((-1 + \[Chi]^2)*\[Omega]^2)] + 12*Sqrt[(-1 + 4*\[Nu])*(-1 + \[Chi]^2)*\[Omega]^2] + 156*\[Chi]^2*Sqrt[(-1 + 4*\[Nu])*(-1 + \[Chi]^2)*\[Omega]^2] + 
    72*\[Chi]^4*Sqrt[(-1 + 4*\[Nu])*(-1 + \[Chi]^2)*\[Omega]^2] + 48*\[Chi]*\[Omega]*Im[PolyGamma[0, 3 + ((2*I)*\[Chi])/Sqrt[1 - \[Chi]^2]]] + 144*\[Chi]^3*\[Omega]*Im[PolyGamma[0, 3 + ((2*I)*\[Chi])/Sqrt[1 - \[Chi]^2]]] + 
    48*\[Chi]*Sqrt[(1 - 4*\[Nu])*\[Omega]^2]*Im[PolyGamma[0, 3 + ((2*I)*\[Chi])/Sqrt[1 - \[Chi]^2]]] + 144*\[Chi]^3*Sqrt[(1 - 4*\[Nu])*\[Omega]^2]*Im[PolyGamma[0, 3 + ((2*I)*\[Chi])/Sqrt[1 - \[Chi]^2]]]))/60 + 
 (\[Nu]^2*\[Omega]^5*\[ScriptCapitalF]\[ScriptCapitalH]int[\[Chi], -1 + (2*\[Omega]^(2/3)*(3 + Sqrt[3*\[Chi]^2 + (1 + (1 - \[Chi]^2)^(1/3)*((1 - \[Chi])^(1/3) + (1 + \[Chi])^(1/3)))^2] - 
        Sqrt[(2 - (1 - \[Chi]^2)^(1/3)*((1 - \[Chi])^(1/3) + (1 + \[Chi])^(1/3)))*(4 + (1 - \[Chi]^2)^(1/3)*((1 - \[Chi])^(1/3) + (1 + \[Chi])^(1/3)) + 
            2*Sqrt[3*\[Chi]^2 + (1 + (1 - \[Chi]^2)^(1/3)*((1 - \[Chi])^(1/3) + (1 + \[Chi])^(1/3)))^2])]*Sign[\[Chi]]))/(1 - \[Chi]*\[Omega])^(2/3)])/(1 - \[Chi]*\[Omega])^5;
...
F\[Phi][\[Omega]_,\[Chi]_,\[Nu]_,m_,\[Chi]0_,\[Nu]0_,m0_]:=\[Omega];
...
\[CapitalDelta]Uint = Interpolation[invardata,Method->"Hermite",InterpolationOrder->{All,All}];
